                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav my-2 my-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link page-scroll" href="<?= base_url('pricelist'); ?>"><svg
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('login'); ?>"><svg stroke="currentColor"
                                    ...
                                    <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('logout'); ?>"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="20px" width="20px" padding="0" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M17 8l-1.41 1.41L17.17 11H9v2h8.17l-1.58 1.58L17 16l4-4-4-4zM5 5h7V3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h7v-2H5V5z"></path></svg></a>
                            </li>
                        </ul>
                    </div>
                </div>
